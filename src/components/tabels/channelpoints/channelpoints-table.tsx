...
interface Props {
  columns: ColumnDef<TwitchChannelPointsReward, any>[];
}
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    onClick={() => {
                      const channelpoints = table.getSelectedRowModel().rows.map((row) => row.original);

                      deleteChannelPoint(channelpoints)
                    }}
                  >
                    Delete
                  </AlertDialogAction>
