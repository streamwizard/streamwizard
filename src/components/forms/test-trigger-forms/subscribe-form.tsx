...
export function SubscribeForm({ selectedStreamer, action, metadata, onClose }: FormProps) {
        ...
        <Field>
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              id="is_gift"
              {...form.register("is_gift")}
              className="h-4 w-4 rounded"
            />
            <FieldLabel htmlFor="is_gift" className="cursor-pointer">Is Gift</FieldLabel>
          </div>
        </Field>
      </FieldGroup>
      <DialogFooter>
