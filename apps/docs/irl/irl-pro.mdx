...
<Steps>
  ...
  <Step title="Go live">
    ...
    While you're live, the overlay shows your connection name, bitrate, and
    a timer. On SRTLA you also get a card per network with its bitrate and
    ping, so you can watch the bond do its thing.
