...
<Steps>
  ...
  <Step title="Turn it on">
    Overlays render only while active. Flip the switch on the overlay card.

    <Frame caption="Active, or the phone gets a blank page.">
      <img src="/images/irl/monitor-06-overlay-card-active.png" alt="Overlay card set to active" style={{ maxWidth: "480px" }} />
    </Frame>
  </Step>
</Steps>
