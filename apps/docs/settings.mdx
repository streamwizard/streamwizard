...
| --- | --- |
| **Auto-sync clips** | Leave it on and StreamWizard checks Twitch every five minutes while you're live, pulls in new clips, then does one last pass when you go offline. Turn it off to [sync manually](/clips/overview) instead. |
