...
/** Supported timeline segment types */
export type TimelineSegmentType = "muted" | "ad_break";

/** Represents a segment (time range) on the timeline */
export interface TimelineSegment {
  /** Type of segment for styling */
