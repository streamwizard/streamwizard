...
import { Activity, DoorOpen, ShieldCheck, Ticket, type LucideIcon } from "lucide-react";
...
export default async function DiscordOverviewPage() {
  ...
  const [guild, channels, roles, welcome, activity, ignored, tickets, openTickets, permissions, audit] = await Promise.all([
    getGuild(),
    getGuildChannels(),
    getGuildRoles(),
